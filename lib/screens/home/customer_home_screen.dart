...
import '../map/map_screen.dart'; // ADD THIS IMPORT
...
class _CustomerHomeScreenState extends State<CustomerHomeScreen> {
  ...
  // THIS IS THE KEY METHOD - it switches between different screens
  Widget _getSelectedScreen() {
    switch (_selectedIndex) {
      case 0:
        return _buildHomeScreen(); // Home - unchanged
      case 1:
        return const BookingsScreen(); // Bookings
      case 2:
        return const MapScreen(); // MAP - replaces Post Job
      case 3:
        return const NotificationsScreen(); // Notifications
      case 4:
  ...
  // Home screen content - COMPLETELY UNCHANGED
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return CategoryCard(
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (_) => ServiceDetailScreen(category: category)));
              },
            );
          },
        );
  ...
  Widget _buildHandymenList() {
    return StreamBuilder<List<Map<String, dynamic>>>(
      stream: _firestoreService.getTopRatedHandymen(limit: 5),
      builder: (context, snapshot) {
        ...
        if (handymen.isEmpty) {
          return const Padding(
            ...
            child: Text("No top rated specialists found.", style: TextStyle(color: AppColors.textLight)),
          );
        }
  ...
  // BOTTOM NAVIGATION - Changed "Post Job" to "Map"
  Widget _buildBottomNavBar() {
    return BottomNavigationBar(
      ...
      items: const [
        ...
        BottomNavigationBarItem(icon: Icon(Icons.map), label: 'Map'), // CHANGED THIS
